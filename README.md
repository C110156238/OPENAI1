...
1.欲修改程式當中的三個地方：LINEBOT Channel Access Token、Channel Secret以及MongoDB的資料庫連結網址<br>


2.[進入 MongoDB官網 並註冊帳號](https://www.mongodb.com/)
<br>
...
<br><br>
5.[進入LINE Developer官網建立LINE BOT帳號](https://developers.line.biz/)<br>

6.進入LINE Developer官網，將LINE@帳號的Channel Access Token、Channel Secret置換成自己的，位置如下圖<br>
<br>
...
<br><br>
### 內建指令
**@c**: 將目前以放入MongoDB資料庫的資料以字串型式回傳到LINE對話框<br>
**@r**: 查詢一筆最新的資料，並以字串型式回傳到LINE對話框<br>
**@rec**: 查詢透過webhook event傳送到LINEBOT的文字訊息紀錄，整理後回傳至對話框<br>
**@d**: 將目前所儲存的資料刪除，並回傳刪除的資料筆數於對話框<br>
**@u**: 將目前所儲存的資料更新，並回傳更新的資料<br>
<br><br>
====================================<br>